...
class topviewmousedataset(Kpt2dSviewRgbImgTopDownDataset):
    ...
    def __init__(self,
        ...
        if dataset_info is None:
            ...
            cfg = Config.fromfile('configs/_base_/datasets/topviewmouse.py')
    ...
    def evaluate(self, outputs, res_folder, metric='mAP', **kwargs):
        ...
        for output in outputs:
            ...
            for i in range(batch_size):
                ...
                image_name = image_paths[i][len(self.img_prefix):].lstrip('/')
